...
, IAggregateRoot
{
  ...
  /// The specification containing the filter and includes.
  /// </param>
  /// <returns>
  /// A IEnumerable<typeparamref name="T"/> of entities.
  /// </returns>
  ValueTask<IQueryable<T>> ListAsync(
  ...
  /// </param>
  /// <returns>
  /// The entity matching the specification, or default(T) if none found.
  /// </returns>
